  ...
  try {
    ...
    const subscriptionPlansData = [
      ...
      },
      {
        key: 'STARTER',
        name: 'Starter Plan',
        description: 'QR Menu, Waiter Call, Staff Management, and Basic Dine-In & Takeaway Ordering.',
        includedFeatureKeys: ['qr_menu', 'ordering', 'waiter_call', 'staff_management', 'takeaway'],
      },
      {
        key: 'PROFESSIONAL',
        name: 'Professional Plan',
        description: 'Full Dine-In & Takeaway ordering, Staff Management, Customer OTP, Payments, Customer Display, Mobile App, and Analytics.',
        includedFeatureKeys: [
          'qr_menu',
          'ordering',
          'customer_otp',
