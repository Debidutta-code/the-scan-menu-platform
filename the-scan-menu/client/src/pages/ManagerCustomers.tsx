      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5 sm:gap-3">
        <div className="bg-white p-3.5 rounded-2xl border border-slate-200/80 shadow-2xs flex items-center gap-3">
          ...
          <div>
            ...
            <h3 className="text-lg sm:text-xl font-black font-mono text-slate-900 mt-0.5">{totalDiners}</h3>
          </div>
        </div>
        ...
        <div className="bg-white p-3.5 rounded-2xl border border-slate-200/80 shadow-2xs flex items-center gap-3">
          ...
          <div>
            ...
            <h3 className="text-lg sm:text-xl font-black font-mono text-slate-900 mt-0.5">{repeatDiners}</h3>
          </div>
        </div>
        ...
        <div className="bg-white p-3.5 rounded-2xl border border-slate-200/80 shadow-2xs flex items-center gap-3">
          ...
          <div>
            ...
            <h3 className="text-lg sm:text-xl font-black font-mono text-emerald-600 mt-0.5">{formatPrice(totalRevenue)}</h3>
          </div>
        </div>
      </div>
                              ...
                              {ord.items?.map((it: any, i: number) => (
                                <div key={i} className="flex justify-between text-xs text-slate-600">
                                  <span className="flex items-center gap-1.5 flex-wrap">
                                    ...
                                    {it.variantName && !it.nameSnapshot?.includes(`(${it.variantName})`) && (
                                      <span className="text-[9px] font-bold text-slate-700 bg-slate-100 border border-slate-200 px-1 py-0.2 rounded font-mono">
                                        {it.variantName}
                                      </span>
                                    )}
                                  </span>
