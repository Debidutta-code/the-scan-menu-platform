        ...
        <nav className="flex-1 p-2 space-y-0.5 overflow-y-auto custom-scrollbar">
          ...
          {isEnabled('ordering') && (
            ...
            >
              ...
              <span className={`px-1.5 py-0.5 text-[9px] rounded-full font-bold font-mono transition-opacity ${
          ...
          {!isStaff && isEnabled('kds') && (
            ...
            >
              <div className="flex items-center gap-2.5">
                <Flame className="w-3.5 h-3.5 text-amber-600" strokeWidth={2} />
          ...
          {!isStaff && isEnabled('customer_display') && (
            <a
              ...
              className="flex items-center justify-between w-full px-3 py-1.5 rounded-xl text-xs font-semibold text-emerald-800 bg-emerald-50/70 hover:bg-emerald-100/90 border border-emerald-200/80 transition-all group"
              title="Open Customer Live Display (TV Queue Screen) in a new tab"
            >
              <div className="flex items-center gap-2.5">
                <Tv className="w-3.5 h-3.5 text-emerald-600 group-hover:scale-110 transition-transform" strokeWidth={2} />
                <span>Live TV Display</span>
              </div>
              <span className="text-[9px] font-bold font-mono px-1.5 py-0.5 rounded-full bg-emerald-200 text-emerald-900 uppercase">
                TV ↗
              </span>
            </a>
          )}
          ...
          {isEnabled('waiter_call') && (
            ...
            >
              ...
              <span className={`px-1.5 py-0.5 text-[9px] rounded-full font-bold font-mono bg-amber-500 text-slate-950 transition-opacity ${
          ...
          {isEnabled('inventory') && (
            ...
            >
              <div className="flex items-center gap-2.5">
                <Package className="w-3.5 h-3.5 text-amber-500" strokeWidth={1.75} />
          ...
          {!isStaff && isEnabled('crm') && (
            ...
            >
              <UserCheck className="w-3.5 h-3.5 text-amber-500" strokeWidth={1.75} />
              <span>Customers</span>
            </button>
          )}
