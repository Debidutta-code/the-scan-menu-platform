...
router.post('/:restaurantId/orders/:orderId/clear', requireFeature('ordering') as any, requireRestaurantAccess as any, requireRole('MANAGER', 'STAFF') as any, orderController.clearOrder);
